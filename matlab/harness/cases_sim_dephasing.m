function cases = cases_sim_dephasing(Q_lib, nstates_list)
% CASES_SIM_DEPHASING  Test case templates for the sim_dephasing operator.
%
%   cases = cases_sim_dephasing(Q_lib, nstates_list)
%
...
%   these checks; a representative nstates is sufficient.
%
...
%   are already a stress test at any size, so the smallest available nstates
%   is adequate.
%
